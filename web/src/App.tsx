  ...
  return (
    <>
      ...
      <main>
        ...
        <Section3 variant={variant} state={state} runs={scopeRuns(runs, state.task, state.s3)} turns={scopeTurns(turns, state.task, state.s3)} reps={reps} agentTypes={agents3} onToggle={sectionToggle('s3')} onClear={sectionClear('s3')} />
      </main>
    </>
  );
}
